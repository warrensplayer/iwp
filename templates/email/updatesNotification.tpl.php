...
<div style="background:#dce1e3;">
  <table bgcolor="#FFFFFF" background="<?php echo APP_URL; ?>images/email/bg.gif" width="600" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse; margin:auto; border-bottom:2px solid #1d292c;">
